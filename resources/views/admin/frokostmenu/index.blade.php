<x-admin-layout>
    <main class="py-12 w-screen h-screen overflow-y-scroll flex items-center justify-center">
        <div class="flex flex-col w-10/12 min-h-full">
            ...
            @endif
            <div class="mb-4">
                <a href="{{ route('admin.frokostmenu.create') }}" class="btn btn-primary">{{ __('Opret Ny Frokostmenu') }}</a>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                <div class="flex h-full">
                                    <a href="{{ route('admin.frokostmenu.edit', $menu) }}" class="btn btn-primary mr-2">{{ __('Edit') }}</a>
                                    <form method="POST" action="{{ route('admin.frokostmenu.destroy', $menu) }}" class="">
                                        @csrf
                                        @method('delete')
