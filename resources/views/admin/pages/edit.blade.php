                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" name="name" placeholder="{{ __('Enter name') }}" value="{{ $page->name }}">
                            @error('name') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                            <label for="online" class="block text-gray-700 text-sm font-bold mb-2">Online:</label>
                            <input type="checkbox" class="form-checkbox h-6 w-6 text-green-500" id="online" name="online" @if($page->online) checked @endif />
