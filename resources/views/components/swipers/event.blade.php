<div class="w-full h-full event-swiper ">
			...
			@foreach($slides as $slide)
                <div class="swiper-slide cursor-pointer" data-history="{{ $slide->slug }}">
                    ...
                    <div class="flex flex-col w-full h-full absolute top-0 left-0 items-center justify-center bg-black bg-opacity-25 p-1">
                        <h4 class="text-xs sm:text-lg md:text-2xl xl:text-4xl font-sche font-bold leading-none text-center w-full text-white">{!! $slide->name !!}</h4>
    ...
    <div class="swiper-container gallery-main">
        <div class="absolute inset-y-0 left-0 md:left-8 z-10 items-start pt-48 flex">
		...
		<div class="swiper-wrapper h-full">
            @foreach($slides as $slide)
            <div class="swiper-slide h-full" data-history="{{ $slide->slug }}">
                <picture>
                    @if ($slide->getFirstMedia('event'))
                ...
                <div class="flex flex-col w-full h-screen-7/10 absolute top-0 left-0 items-center justify-start bg-white bg-opacity-75 overflow-y-auto pb-4">
                    <h1 class="text-4xl font-sche w-full text-center mt-4 leading-snug font-extrabold">{{ $slide->name }}</h1>
                    ...
                    <div class="w-full flex flex-col items-center md:items-start md:flex-row p-8 md:py-4 md:px-16 text-center">
                    ...
                    <div class="text-2xl font-sche font-bold w-full text-center">
        ...
        <div class="absolute inset-y-0 right-0 md:right-8 z-10 flex items-start pt-48">
