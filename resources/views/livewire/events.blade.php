<main class="flex flex-col items-center justify-start h-full min-h-screen min-w-full overflow-x-hidden">
    <div id="overlay" class="relative pointer-events-none top-0 left-0 w-full h-screen-1/10 overflow-hidden border-black border-b-4">
    ...
    <div class="flex w-full items-center justify-center absolute top-0 left-0 mt-2 md:mt-2">
