                    ...
                    <tbody>
                        @foreach($cart['products'] as $product)
                            <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 border-b border-grey-light">{{ $product->cateringMenu->title }}</td>
                                <td class="py-4 px-6 border-b border-grey-light">{{ $product->cateringMenu->price }}</td>
